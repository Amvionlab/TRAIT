  ...
  const articles = [
    {
      ...
      content: (
        <>
          ...
          <p className="text-sm dark:text-gray-400 text-gray-700  leading-relaxed mb-4">
          ...
          <ul className="list-disc list-inside text-sm dark:text-gray-400 text-gray-700  leading-relaxed mb-4">
          ...
          <p className="text-sm dark:text-gray-400 text-gray-700  leading-relaxed mt-4">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="list-disc list-inside text-sm dark:text-gray-400 text-gray-700  leading-relaxed mb-4 mt-2">
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ol className="list-decimal list-inside text-sm dark:text-gray-400 text-gray-700  leading-relaxed mb-4">
            <li>Risk Aversion</li>
...
return (
  <div >
    <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pt-1  w-full pl-4 dark:text-white">
      {/* Left Column: Main Article Content */}
      <div className="md:col-span-7 md:h-[80vh] md:sticky md:top-0 flex flex-col pl-2 pr-8">
        {/* Fixed header + title */}
        <div className="shrink-0">
          <header className="flex items-center space-x-20 text-xs dark:text-gray-400 text-gray-700  mb-6">
      ...
      >
        ...
        >
          {/* Number */}
          <div className="text-xs dark:text-gray-400 text-gray-700  self-start">{`0${article.id}`}</div>
          ...
          <div className="relative w-full">
            ...
            <p className="absolute w-[60%] bottom-0 right-0 text-xs dark:text-gray-400 text-gray-700  px-2 py-1">
              {article.title}
            </p>
          </div>
        </div>
